...
public class ItemNyxSlab extends ItemBlock {

    private final Supplier<NyxSlab> singleSlab;
    private final Supplier<NyxSlab> doubleSlab;

    public ItemNyxSlab(Block block, Supplier<NyxSlab> singleSlab, Supplier<NyxSlab> doubleSlab) {
        super(block);
